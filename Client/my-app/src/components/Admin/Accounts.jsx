            ...
            <div className="tm-bg-primary-dark tm-block tm-block-settings">
              ...
              <form action="" className="tm-signup-form row">
                ...
                >
                  ...
                  <Link to="/reset" style={{display: 'block',
marginRight: '3vw'}}>
                    <button
                      type="submit"
                ...
                <div className="col-12">
                  <button
                    ...
                    onClick={()=>{
                        ...
                        fetch('http://localhost:9001/admin/deleteCustomer',{method:"DELETE",headers: { "Content-Type": "application/json" },body:JSON.stringify(customer)}).then(()=>{console.log('Customer Deleted');})
