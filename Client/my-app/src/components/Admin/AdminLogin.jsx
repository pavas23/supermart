            ...
            <div class="login_page4">
                <div class="form-box4" style={{ marginTop: "20vh" }}>
                    <div class="button-box1">
                        <div id="btn1" style={{"top": "0","left": "0px","position":"absolute", "width": "130px", "padding-left": "7%","padding-top": "2%",
                    "height": "130%","background":"linear-gradient(to right, #22db15, #fbff00)","border-radius": "30px",
                    "transition": "0.5s"}}>Log in as Admin</div>
                        <button type="button" class="toggle-btn1" onclick="login()"></button>
                    </div>
                    <form method="POST" onSubmit={handleSubmit} autoComplete="off" id="login-form">
                        ...
                        style={{"width":"60%","padding":"10px 30px","cursor":"pointer","display":"block","margin":"auto",
                    ...
                    <Link to="/login"><a class="user_log4"style={{"marginLeft":"80px","marginTop":"190px"}} >Log in as User</a></Link>
                    <Link to="/man_log"><a class="admin_log4"style={{"marginLeft":"200px","marginTop":"190px"}}>Log in as Manager</a></Link>
                </div>
            </div>
        </>
    );
