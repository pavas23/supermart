...
export default function Login(props) {
    ...
    const handleSubmit = async (event) => {
        ...
        async function sendOtp() {
            var responseOtp = await fetch("http://127.0.0.1:9001/customer/forgotPassword", {
                method: "POST",
                headers: {
        ...
        async function addCustomer() {
            ...
            response = await response.json(); // will return true if successfull otherwise false
            ...
            if (response) {
                ...
                window.alert("Make account with BITS Pilani Hyderabad campus ID !!! or The account with this id already exists!!");
            }
        }
        addCustomer();
    }
            ...
            <div class="login_page4">
                <div class="form-box4" style={{ marginTop: "20vh" }}>
                    <div class="button-box7">
                        <div id="btn9" style={{"top": "0","left": "-20px","position":"absolute", "width": "160px", "padding-left": "15%","padding-top": "2%",
                    "height": "130%","background":"linear-gradient(to right, #22db15, #fbff00)","border-radius": "30px",
                    "transition": "0.5s"}}>Register as User</div>
                    ...
                    <form method="POST" onSubmit={handleSubmit} autoComplete="off" id="login-form">
                        ...
                        style={{"width":"75%","padding":"10px 0","margin":"5px 0","border-left":"0","border-top":"0","border-right":"0",
                        "border-bottom":"1px solid #999","outline":"none","background":"transparent","marginTop":"60px",
                         "marginLeft":"40px","marginRight":"40px"}}/>

                        <input type="email" name="email" id="input_email" value={credentials.email.toLowerCase()} autoCapitalize="off" onChange={onChange} required placeholder="Enter your user ID"
                        style={{"width":"75%","padding":"10px 0","margin":"5px 0","border-left":"0","border-top":"0","border-right":"0",
                        ...
                        style={{"width":"30%","padding":"10px 30px","cursor":"pointer","display":"block","margin":"auto",
                        "background":"linear-gradient(to right, #22db15, #fbff00)","border":"0","outline":"none","border-radius":"30px",
                        "marginTop":"20px"}}/>
                    </form>

                    <Link to="/login"><a class="admin_log6" style={{"marginLeft":"275px"}}>Log in</a></Link>
                </div>
            </div>
        </>
    );
