...
export default function Reset(props) {
    ...
    const handleSubmit = (event) => {
        ...
        if(credentials.otp == props.otpApp){
            resetPassword();
        }
        else{
            ...
            <div class="login_page4">
                <div class="form-box4">
                    <div class="button-box1">
                        <div id="btn1"  style={{"top": "0","left": "-25px","position":"absolute", "width": "160px", "padding-left": "20%","padding-top": "2%",
                    "height": "130%","background":"linear-gradient(to right, #22db15, #fbff00)","border-radius": "30px",
                    "transition": "0.5s"}}>Reset Password</div>
