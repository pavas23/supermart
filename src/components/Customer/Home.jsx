    ...
    <>
      ...
      <section className="features2" id="features2">
        <h1 className="heading3">
          {" "}
          <b>Our</b> <p>Features</p>{" "}
        </h1>

        <div className="swiper feature-slider">
          <div className="swiper-wrapper">
            <div
              className="swiper-slide1 box"
              id="exception"
              style={{ margin: "2vw", height: "40vh" }}
            >
              <img src={require("../../image/feature-img-1.png")} alt="" />
              <h3>Fresh And Organic</h3>
              <p>
                All our products are organically grown with no genetic
                modification!
              </p>
            </div>
            <div
            ...
            >
              ...
              <h3>Easy Payments</h3>
              <p>
                Innovative credit system that allows you to top up occassionally
                and spend endlessly!
              </p>
            </div>
          </div>
      ...
      <section
        className="footer2"
        style={{ height: "40vh", paddingTop: "7vh", marginTop: "5vh" }}
      >
        <div className="box-container2">
          <div className="box2">
            <h3>
              {" "}
              BBB <i className="fas fa-shopping-basket"></i>{" "}
            </h3>
          ...
          <div className="box2">
            ...
            <a href="#" className="links">
              {" "}
              <i className="fas fa-phone"></i> +91 6263983740{" "}
            </a>
            <a href="#" className="links">
              {" "}
              <i className="fas fa-phone"></i> +91 9999178883{" "}
            </a>
            <a href="#" className="links">
              {" "}
          ...
          <div className="box2">
            ...
            <a href="#features2" className="links">
              {" "}
            ...
            <a href="#categories2" className="links">
              {" "}
            ...
            <Link to="/review">
              <a className="links">
                {" "}
                <i className="fas fa-arrow-right"></i> Write a Review{" "}
              </a>
            </Link>
          </div>
        </div>
